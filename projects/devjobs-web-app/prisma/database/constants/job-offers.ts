...
export const jobOffers: JobOffer[] = [
  {
    ...
    companyId: '63893f797fe7d05cd13c5bbf',
    contract: 'Full Time',
    createdAtTimestamp: 1670960000000,
    ...
    roleContent: `We are looking for a Senior Software Engineer to join as one of our first hires. As we iterate on our MVP, you will have the opportunity to drive the vision and own the build behind our digital experience. You’ll have the support of an experienced technical advisor, a Head of Product, and an external team to work with.`,
    roleItems: [
  ...
  },
  {
    ...
    companyId: '638afbb1140d24a2f4622979',
    contract: 'Part Time',
    createdAtTimestamp: 1670960000001,
    ...
    id: '638afcb50f9d0f038d08c170',
    location: 'United States',
    position: 'Haskell and PureScript Dev',
    postedAtSlug: '20h ago',
    requirementsContent: `We are looking to carefully add great developers which care about solving problems & which have been in a relationship with Purescript and/or Haskell for at least 3 years (Not necessarily monogamous though).`,
    requirementsItems: [
    ...
    roleContent: `The role is more frontend-focused where you will be tasked to build browser-based UIs for Haskell applications.`,
    roleItems: [
  ...
  },
  {
    ...
    companyId: '638b094c3cc5f6d2d08eb9da',
    contract: 'Part Time',
    createdAtTimestamp: 1670960000002,
    ...
    roleContent: `This is an IDEAL job if you already have a few years of software engineering experience under your belt, and you want to be part of a small, intensely skilled team, who feel total ownership of their work, and can’t imagine a day without learning & coding. You will play a crucial role in the Vector platform and everything you do will matter.`,
    roleItems: [
  ...
  {
    applyUrl: 'https://example.com/office-lite/apply',
    companyId: '638b379dfc652c1a1f18e9db',
    contract: 'Full Time',
    createdAtTimestamp: 1670960000003,
    ...
    id: '638b384fc0f8ab664c814178',
    location: 'Japan',
    position: 'Senior Application Engineer',
    postedAtSlug: '2d ago',
    requirementsContent: `As a hands-on subject matter expert, you will use expert-level engineering knowledge to provide technical support and help translate customer requirements into exciting new product features. You will be working within multi-disciplinary teams to create pervasive simulation solutions, advance your industry knowledge, and grow the business impact.`,
    requirementsItems: [
  ...
  },
  {
    ...
    companyId: '638b3bb3f868816e2b7f303d',
    contract: 'Part Time',
    createdAtTimestamp: 1670960000004,
    ...
    id: '638b3c0973c39a29f39a1b7c',
    location: 'Japan',
    position: 'Remote DevOps Engineer',
    postedAtSlug: '2d ago',
    requirementsContent: `We are looking for talented and motivated engineers who can hit the ground running and take our products to the next level. The engineers who are building our platform across the stack are always willing to go the extra mile to deliver the highest quality software and client experiences. Ideally, you would have:`,
    requirementsItems: [
  ...
  },
  {
    ...
    companyId: '638b3e06e687b92e5a7d33ce',
    contract: 'Part Time',
    createdAtTimestamp: 1670960000005,
    description: `Creative is seeking a Desktop Support Manager responsible for managing and leading a high-performance team in a dynamic environment. The ideal candidate should have management experience, a strong technical skill set, exceptional client service skills and enjoy mentoring a team.`,
    id: '638b3e611b71faa4f9aea6c8',
    location: 'Germany',
    position: 'Desktop Support Manager',
    postedAtSlug: '4d ago',
    requirementsContent: `You are likely someone with a solid background in end-user support and troubleshooting, as this position involves dealing with a large, and often changing, number of day-to-day issues which arise in supporting the information technology requirements of our applications.`,
    requirementsItems: [
    ...
    roleContent: `This is an 80% management and 20% hands-on supervisory role where you will be responsible for the support of automation technologies and managing a team of support engineers in a 24x7 high-volume environment.`,
    roleItems: [
  ...
  },
  {
    ...
    companyId: '638b3f6baf3a0472cff7ac3a',
    contract: 'Full Time',
    createdAtTimestamp: 1670960000006,
    ...
    id: '638b3fbcf97d0ce40b0398b5',
    location: 'United States',
    position: 'iOS Engineer',
    postedAtSlug: '1w ago',
    requirementsContent: `You are an experienced mobile engineer looking to make Pomodoro one of the best mobile experiences out there. You are someone who excels at customer-centric product development and has a passion for working on application architecture and design, and making smooth, delightful experiences. You care deeply about quality, are energized by partnership and collaboration, and you strive to enable others around you to excel.`,
    requirementsItems: [
  ...
  },
  {
    ...
    companyId: '639150ccb0a6a292ca04f637',
    contract: 'Full Time',
    createdAtTimestamp: 1670960000007,
    ...
    id: '63915103fe030329cfd66fef',
    location: 'United Kingdom',
    position: 'Senior EJB Developer',
    postedAtSlug: '1w ago',
    requirementsContent: `The candidate must have work experience in all aspects of designing and constructing J2EE/EJB systems and developing system requirements and design specifications, and J2EE/EJB Coding for new and existing applications.`,
    requirementsItems: [
    ...
    roleContent: `Job responsibilities will include developing scalable Java applications while providing expertise in the full software development lifecycle, from concept and design to testing.`,
    roleItems: [
  ...
  },
  {
    ...
    companyId: '6391520c02e4fa0ce5cb9fee',
    contract: 'Part Time',
    createdAtTimestamp: 1670960000008,
    ...
    roleContent: `Beyond working closely with our team to build an exciting app, you’ll be leading Frontend development of our React/Next.js product. You’ll be coming up with UI/UX for the app and making architectural decisions for the frontend.`,
    roleItems: [
  ...
  },
  {
    ...
    companyId: '639152f4c2a5bb0765a09b6a',
    contract: 'Freelance',
    createdAtTimestamp: 1670960000009,
    ...
    id: '6391532f365d04caf84bcabf',
    location: 'United States',
    position: 'App & Website Designer',
    postedAtSlug: '2w ago',
    requirementsContent: `To be successful in this role, you should have experience with design software and wireframe tools preferably Figma. You should also have a portfolio of professional design projects that includes work with web/mobile applications.`,
    requirementsItems: [
    ...
    roleContent: `You’ll create both functional and appealing features that address our clients’ needs and help us grow our customer base. We expect you to have experience with market/user research and stay current with most recent trends, tools, workflows.`,
    roleItems: [
  ...
  },
  {
    ...
    companyId: '6391546d3a97469c2cbf5401',
    contract: 'Part Time',
    createdAtTimestamp: 1670960000010,
    ...
    id: '639154a969e4b3aeb7868fd0',
    location: 'New Zealand',
    position: 'Fullstack Developer',
    postedAtSlug: '1mo ago',
    requirementsContent: `We'd love to hear from you if you take ownership of your work and continuously want to improve the products you've built. We're looking for developers who have an uncanny ability to work very well cross-functionality in a flat startup.`,
    requirementsItems: [
  ...
  },
  {
    ...
    companyId: '6391554da7ba84f45bfb7541',
    contract: 'Part Time',
    createdAtTimestamp: 1670960000011,
  ...
  },
  {
    ...
    companyId: '6391546d3a97469c2cbf5401',
    contract: 'Full Time',
    createdAtTimestamp: 1670960000012,
  ...
  },
  {
    ...
    companyId: '6391520c02e4fa0ce5cb9fee',
    contract: 'Full Time',
    createdAtTimestamp: 1670960000013,
  ...
  },
  {
    ...
    companyId: '638afbb1140d24a2f4622979',
    contract: 'Full Time',
    createdAtTimestamp: 1670960000014,
    ...
    roleContent: `In this role, you are part of our Product team comprised of Frontend & Backend Developers, UX & UI Specialists and Product Owners. You'll work on mission critical projects from the first day on, support other engineers, share your knowledge with your colleagues, and contribute to agile projects.`,
    roleItems: [
